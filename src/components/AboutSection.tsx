      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-48 h-48 rounded-lg bg-serene-100 -z-10" />
          </div>
          
          {/* Content */}
          <div>
            <h3 className="subsection-title text-serene-800">Finding Peace in Reflection</h3>
...
const AboutStat = ({ number, text }: { number: string; text: string }) => {
  return (
    <div className="bg-serene-50 rounded-lg p-4 text-center">
      <p className="text-2xl font-playfair font-medium text-serene-700">{number}</p>
